...
const TarjousLomake = () => {
    ...
    const generatePDF = () => {
        ...
        doc.text(
            `Tarjous voimassa: ${new Date().toLocaleDateString()}`,
            14,
            42
        );
        ...
        doc.text(
            'Lopullinen lasku perustuu käytettyihin tunteihin ja kuluihin +/- 25% välillä.',
            14,
            200
        );
                ...
                <Container maxWidth='md' className='tarjous'>
                    <Box>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    onChange={(e) =>
                                        setMatkakulut({ lahto: e.target.value })
                                    }
                                    variant='outlined'
                                    fullWidth
                                />
                            ...
                            <Grid item xs={12}>
                                <Typography>
                                    ...
                                    {Number(
                                        matkakulut.maara *
                                            (matkakulut.km * KILOMETRIKUSTANNUS)
                                    ).toFixed(2) || 0}
                                </Typography>
                            </Grid>
                        </Grid>
                        ...
                        <form>
                            <Grid container spacing={2} alignItems='center'>
                                ...
                                <Grid item xs={12}>
                                    <Typography>
                                        Kustannus:{' '}
                                        {(tuntiarvio * tuntihinta).toFixed(2)}
                                    </Typography>
                                </Grid>
                                <Grid item xs={12}>
                                    <Button
                        ...
                        <Box mt={4}>
                            ...
                            <hr />
                            <Typography variant='h6'>
                                Tarjoukseen Kuulumattomat Asiat
                            </Typography>
                            <TextField
